...
public class RKTools {
    ...
    */
    ...
    private static String toMD5(String st) {
...
//            
    ...
    public Bitmap drawableToBitmap(Context context, String key) {
        if (toMD5(key).equals(hashKey)) {
    ...
    private String getCurrentDate(String key) {
        if (toMD5(key).equals(hashKey)) {
